 ...
 * @author Turna
 */
public class badPassageSensor implements MqttCallback {
    ...
    /////////////////// EDIT HERE ///////////////////////
    private final String UID = "qsE";                  // BFH: tHC  ///// HDI: qsE
...
Connection with WLAN & MQTT Raspberry Pi Broker
    ...
    public void connectHost() throws Exception {
        ...
        ////////////////// EDIT HERE > IP ///////////////////
        ipcon.connect(con.getTgBadIP(), con.getTgPort());       // BFH: ipcon.connect(con.getTgEingangIP(), con.getTgPort()); //// HDI: 
        /////////////////////////////////////////////////////
    }
...
Infrarotsensor
    ...
    public void messageArrived(String topic, MqttMessage message) throws Exception {
        System.out.println(" =========== Room:Bad, Typ:Passage, Message Arrived! =========== ");
    }

    @Override
    public void connectionLost(Throwable cause) {
        System.out.println(" =========== Room:Bad, Typ:Passage, Disconnected! =========== ");
    }

    @Override
    public void deliveryComplete(IMqttDeliveryToken token) {
        System.out.println(" =========== Room:Bad, Typ:Passage, OK! =========== ");
    }
}
