 ...
 * @author Turna
 */
public class badAmLightSensor implements MqttCallback {
...
Infrarotsensor
    ...
    public void messageArrived(String topic, MqttMessage message) throws Exception {
        System.out.println(" =========== Room:Bad, Typ:Ambient Light, Message Arrived! =========== ");
    }

    @Override
    public void connectionLost(Throwable cause) {
        System.out.println(" =========== Room:Bad, Typ:Ambient Light, Disconnected! =========== ");
    }

    @Override
    public void deliveryComplete(IMqttDeliveryToken token) {
        System.out.println(" =========== Room:Bad, Typ:Ambient Light, OK! =========== ");
    }
}
