 ...
 * @author Turna
 */
public class kücheMotionSensor implements MqttCallback {
...
public void doMotion() throws Exception {
		...
		tinkerforg.addMotionDetectedListener(new BrickletMotionDetector.MotionDetectedListener() {
			public void motionDetected() {
                            ...
                            if (is.siotDash == true){
                                ...
                                sdrli.setInputRoomLocMessage("Toilette");                // sdrli.setInputRoomLocMessage(ROOM);
                                try {
                                    sdi.sendInput();
    ...
    public void messageArrived(String topic, MqttMessage message) throws Exception {
        System.out.println(" =========== Room:Küche, Typ:Motion, Message Arrived! =========== ");
    }

    @Override
    public void connectionLost(Throwable cause) {
        System.out.println(" =========== Room:Küche, Typ:Motion, Disconnected! =========== ");
    }

    @Override
    public void deliveryComplete(IMqttDeliveryToken token) {
        System.out.println(" =========== Room:Küche, Typ:Motion, OK! =========== ");
    }
}
