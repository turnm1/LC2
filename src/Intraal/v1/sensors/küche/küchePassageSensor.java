 ...
 * @author Turna
 */
public class küchePassageSensor implements MqttCallback {
    ...
    /////////////////// EDIT HERE ///////////////////////
    private final String UID = "tJN";  // orginal BFH UID: tJN //// HDI UID: qsE ******************************************************************************
...
Connection with WLAN & MQTT Raspberry Pi Broker
    ...
    public void connectHost() throws Exception {
        ...
        ////////////////// EDIT HERE > IP ///////////////////
        ipcon.connect(con.getTgEingang2IP(), con.getTgPort()); // Orginal BFH settings: ipcon.connect(con.getTgEingang2IP(), con.getTgPort());
        /////////////////////////////////////////////////////
    }
...
Infrarotsensor
    ...
    public void messageArrived(String topic, MqttMessage message) throws Exception {
        System.out.println(" =========== Room:Küche, Typ:Passage, Message Arrived! =========== ");
    }

    @Override
    public void connectionLost(Throwable cause) {
        System.out.println(" =========== Room:Küche, Typ:Passage, Disconnected! =========== ");
    }

    @Override
    public void deliveryComplete(IMqttDeliveryToken token) {
        System.out.println(" =========== Room:Küche, Typ:Passage, OK! =========== ");
    }
}
