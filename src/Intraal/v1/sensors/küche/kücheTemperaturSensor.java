 ...
 * @author Turna
 */
public class kücheTemperaturSensor implements MqttCallback {
...
Connection with WLAN & MQTT Raspberry Pi Broker
    ...
    public void messageArrived(String topic, MqttMessage message) throws Exception {
        System.out.println(" =========== Room:Küche, Typ:Temperatur, Message Arrived! =========== ");
    }

    @Override
    public void connectionLost(Throwable cause) {
        System.out.println(" =========== Room:Küche, Typ:Temperatur, Disconnected! =========== ");
    }

    @Override
    public void deliveryComplete(IMqttDeliveryToken token) {
        System.out.println(" =========== Room:Küche, Typ:Temperatur, OK! =========== ");
    }
}
