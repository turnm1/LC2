 ...
 * @author Turna
 */
public class schlafzCO2Sensor implements MqttCallback {
    ...
    public void getCO2() throws Exception {
        ...
        tinkerforg.addCO2ConcentrationListener(new BrickletCO2.CO2ConcentrationListener() {
            public void co2Concentration(int co2Concentration) {
                ...
                message.setQos(0);
                System.out.println(co2Concentration);
        ...
        tinkerforg.setCO2ConcentrationCallbackPeriod(1000);
    }
