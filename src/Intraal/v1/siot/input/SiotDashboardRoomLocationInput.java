 ...
 * @author Turna
 */
public class SiotDashboardRoomLocationInput {
  ...
  //  private String licence;
    ...
    public void setInputRoomLocMessage(String message) {
        data = message;
    }
    
    public void setInputRoomLocKey(String key) {
        inputKey = key;
    }
    

    // HTTP POST request
    public void sendRoomLocInput() throws Exception {
